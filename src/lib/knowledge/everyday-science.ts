...
export const EVERYDAY_SCIENCE_ARTICLES: KnowledgeArticle[] = [
  ...
  // 66. How Airplanes Fly
  {
    ...
    sections: [
      {
        heading: "The Four Opposing Forces of Aerodynamics",
        paragraphs: [
          "Every aircraft that takes flight is caught in a high-stakes tug-of-war between four fundamental aerodynamic forces:",
          "1. Lift: The upward aerodynamic force generated by air flowing across curved wings, opposing gravity.",
          "2. Weight (Gravity): The downward gravitational pull on the airplane, its fuel, cargo, and passengers.",
          "3. Thrust: The forward mechanical push produced by jet engines or spinning propellers, opposing drag.",
          "4. Drag: The rearward aerodynamic friction and air resistance that tries to slow the aircraft down.",
          "In level, steady cruising flight, an aircraft exists in dynamic equilibrium: Lift exactly balances Weight, and Thrust exactly balances Drag. To climb, Lift exceeds Weight; to accelerate, Thrust exceeds Drag.",
        ],
        diagramId: "airplane-four-forces",
      },
      {
        heading: "How Airfoil Wings Create Lift: Bernoulli & Newton",
        paragraphs: [
          "An airplane wing is engineered with a specialized cross-sectional profile called an Airfoil—gently curved on top and flatter on the bottom. Lift is generated through two complementary physical laws working in tandem:",
          "1. Bernoulli's Principle: Because the upper surface is curved (cambered), oncoming air must travel faster across the top than beneath the flat bottom. Faster-moving air creates an area of lower static pressure above the wing, producing an upward suction effect.",
          "2. Newton's Third Law (Action & Reaction): Wings are tilted into the airflow at an 'Angle of Attack.' As the plane rushes forward, the underside of the wing strikes billions of air molecules and deflects them sharply downward (called downwash). According to Newton's law, pushing massive amounts of air downward creates an equal and opposite upward reaction that lifts the aircraft.",
        ],
        diagramId: "airplane-airfoil-camber",
      },
      {
        heading: "Steering in 3D Space: Ailerons, Elevators, and Rudders",
        paragraphs: [
          "Unlike a car that only turns left or right on a flat road, an airplane navigates through three-dimensional space along three rotational axes: Roll, Pitch, and Yaw.",
          "Ailerons: Hinged flaps on the outer trailing edge of each wing move in opposite directions. When the left aileron tilts up and the right tilts down, the plane banks into a roll to turn smoothly.",
          "Elevators: Flaps on the horizontal tailplane tilt up or down together to pitch the airplane's nose up into a climb or down into a descent.",
          "Rudder: The hinged vertical fin on the tail swings left or right to control yaw, keeping the airplane's nose aligned with the airflow during turns.",
        ],
        diagramId: "airplane-flight-controls",
      },
      {
        heading: "Inside a Jet Engine: High-Bypass Turbofan Thrust",
        paragraphs: [
          "Modern commercial airliners are powered by colossal High-Bypass Turbofan jet engines. A massive titanium intake fan at the front sucks in thousands of pounds of air every second.",
          "About 80% of this air bypasses the engine core entirely, flowing around the outside to generate quiet, highly efficient forward thrust. The remaining 20% enters the engine core, where multiple stages of compressor blades squash the air to 40 times atmospheric pressure.",
          "In the combustion chamber, aviation kerosene fuel is sprayed into the compressed air and ignited, creating a roaring 1,700°C inferno. The expanding superheated gases blast through turbine blades to power the intake fan, then shoot out the exhaust nozzle at 1,000 mph—propelling the aircraft forward via Newton's action-reaction principle.",
        ],
        diagramId: "airplane-jet-engine",
      },
    ],
    vocabulary: [
      { term: "Lift", definition: "The upward aerodynamic force generated by wings moving through air that overcomes the downward pull of gravity." },
      { term: "Thrust", definition: "The forward mechanical force produced by jet engines or propellers that propels an aircraft through the air." },
      { term: "Drag", definition: "The rearward aerodynamic resistance and friction encountered by an object moving through the air." },
      { term: "Weight", definition: "The downward gravitational force acting on the mass of the airplane, fuel, cargo, and passengers." },
      { term: "Aerodynamics", definition: "The branch of physics that studies how gases interact with moving solid bodies." },
      { term: "Airfoil", definition: "The curved, streamlined cross-sectional shape of an aircraft wing designed to maximize lift and minimize drag." },
      { term: "Angle of Attack", definition: "The acute angle between the chord line of a wing and the oncoming direction of relative airflow." },
      { term: "Aileron", definition: "A movable flight control surface on the trailing edge of a wing used to control roll and bank turns." },
      { term: "Turbofan", definition: "A modern jet engine that uses a giant front fan to generate both quiet bypass thrust and core combustion thrust." },
    ],
    facts: [
